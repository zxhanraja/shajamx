...
function WorkApp() {
  ...
  const projects = [
    { title: 'SHAJAMX (THIS SITE)', tags: 'REACT · 3D · GSAP', desc: 'Our flagship digital agency platform. Engineered from scratch without bloated templates, featuring a custom React Three Fiber 3D engine, Lenis smooth scrolling, and hardcore GPU-accelerated GSAP animations. This is the ultimate proof of fluid kinetic design and bleeding-edge web performance designed to wow clients.', color: '#c8ff00', image: 'https://ik.imagekit.io/ioktbcewp/Screenshot%202026-03-28%20172122.png' },
    { title: 'AURA X', tags: 'UI/UX · MOTION · WEBGL', desc: 'A conceptual interface for next-generation spatial computing. Built with Next.js, featuring heavy GSAP timeline scrubbing and immersive Three.js abstract environments that react to user scroll velocity.', color: '#ff3cac' },
    { title: 'NEURAL KINETICS', tags: 'BRANDING · DIGITAL EXPERIENCE', desc: 'A complete branding and digital rollout for an AI startup. Leveraged Vite and custom Shaders alongside Cannon.js physics to create interactive, dynamic fluid simulations directly in the browser.', color: '#00e5ff' },
    { title: 'LUMINA', tags: 'E-COMMERCE · STRATEGY', desc: 'An ultra-premium Headless Shopify storefront. We used Shopify Liquid APIs intertwined with GSAP to create a seamless, app-like shopping experience with zero-reload page transitions.', color: '#bc13fe' },
    { title: 'NEXUS CORE', tags: 'SaaS · PLATFORM', desc: 'A high-performance B2B SaaS dashboard. Built on React and Node.js with complex data virtualization, custom D3.js charting, and dark-mode exclusive brutalist component libraries.', color: '#ffa500' },
    { title: 'SYNESTHESIA', tags: 'INTERACTION · ANIMATION', desc: 'An experimental web audio visualizer built for a music festival. Using P5.js and the Web Audio API to generate real-time 3D fractals based on microphone frequency inputs.', color: '#00ff7f' }
  ];
