...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    const initThree = async () => {
      ...
      renderer = new THREE.WebGLRenderer({ canvas: footerCanvas, alpha: true, antialias: true });
      ...
      // Cleanup function returned from async init
      return () => {
        observer.disconnect();
    ...
    <footer id="footer" itemScope itemType="https://schema.org/WPFooter">
      ...
      <div className="footer-top">
        <div className="footer-left">
          <div className="footer-logo" itemProp="name">
            <img 
              src="https://ik.imagekit.io/ioktbcewp/Futuristic%20letter%20S%20logo%20design.png?tr=f-webp,w-64,h-64" 
              alt="ShajamX Logo" 
              width="28"
              height="28"
              style={{ display: 'block' }}
