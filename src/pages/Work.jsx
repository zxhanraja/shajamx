    ...
    <div ref={containerRef} style={{ width: '100vw', overflow: 'hidden' }}>
      ...
      <section style={{ padding: '15vmax 5% 5vmax', textAlign: 'center', position: 'relative' }}>
        <div style={{ overflow: 'hidden' }}>
          <h1 className="hero-headline react-hero-title" style={{ fontSize: 'clamp(1.5rem, 8vw, 8rem)', letterSpacing: '-0.02em', margin: 0, width: '100%', wordBreak: 'break-word', overflowWrap: 'break-word' }}>PORTFOLIO</h1>
        </div>
