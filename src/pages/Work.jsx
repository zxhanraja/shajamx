...
function Work() {
  ...
  return (
    <div ref={containerRef} style={{ width: '100vw', overflow: 'hidden' }}>
      <SEO
        title="Premium 3D Web Development & Design Portfolio"
        description="Explore ShajamX's work. Our portfolio features premium 3D web experiences, SaaS platforms, and e-commerce stores built for high-end brands."
        path="/work"
      />
      ...
      <section style={{ padding: '15vmax 5% 5vmax', textAlign: 'center', position: 'relative' }}>
        ...
        <p className="react-hero-subtext" style={{ fontSize: 'clamp(1rem, 2vw, 1.5rem)', color: '#f0f0f0', maxWidth: '800px', margin: '1rem auto' }}>
          Premium 3D digital worlds engineered for ambitious brands.
        </p>
      </section>
